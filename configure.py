...
if __name__ == "__main__":
    ...
    for module in modules:
        ...
        command = " ".join([config.sip_bin,
                            ...
                            "-I/opt/qt4-headless/include",
                            "-I/opt/qt4-headless/share/sip/PyQt4",
                            "-Isip",
        ...
        if module == "diana":
            makefile.extra_include_dirs += [
                ...
                "/usr/include/metlibs",
                "/opt/qt4-headless/include",
                "/opt/qt4-headless/include/QtCore",
                "/opt/qt4-headless/include/QtGui"
                ]
            
            makefile.extra_lib_dirs += [diana_lib_dir,
                                        "/opt/qt4-headless/lib"]
            
            makefile.extra_lflags += ["-Wl,-rpath=/opt/qt4-headless/lib"]
